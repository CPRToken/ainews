// src/sections/blog/news/noticias-latest-posts.tsx
    ...
    const fetchPosts = async () => {
      try {
        ...
        const allSnap = await getDocs(
          query(collection(db, 'noticiasPosts'), orderBy('createdAt', 'desc'))
        );
  ...
  return (
    <Container sx={{ py: { xs: 4, md: 4, lg: 5 } }}>
      <Stack
        ...
        sx={{ mb: { xs: 8, md: 6 } }}
      >
        <Typography variant="h3">Últimas Noticias</Typography>
      </Stack>
